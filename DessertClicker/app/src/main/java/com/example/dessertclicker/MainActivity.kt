...
@Composable
private fun DessertClickerApp(dessertClickerViewModel: DessertClickerViewModel = viewModel()) {
    ...
    Scaffold(
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = {
                dessertClickerViewModel.updateDessertState()
            },
